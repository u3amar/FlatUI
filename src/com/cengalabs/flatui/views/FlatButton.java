...
public class FlatButton extends Button implements Attributes.AttributeChangeListener
{
	...
	private void init(AttributeSet attrs)
	{
		...
		if (attrs != null)
		{
			...
			attributes.setRadius(a.getDimensionPixelSize(R.styleable.FlatButton_cornerRadius, Attributes.globalRadius));

			attributes.setPaddingLeft(a.getDimensionPixelSize(R.styleable.FlatButton_paddingLeft, 0));
			attributes.setPaddingRight(a.getDimensionPixelSize(R.styleable.FlatButton_paddingRight, 0));
			attributes.setPaddingBottom(a.getDimensionPixelSize(R.styleable.FlatButton_paddingBottom, 0));
			attributes.setPaddingTop(a.getDimensionPixelSize(R.styleable.FlatButton_paddingTop, 0));
		...
		normalFront.setPadding(attributes.getPaddingLeft(), attributes.getPaddingTop(), attributes.getPaddingRight(), attributes.getPaddingBottom());
		...
		// normalBack.setPadding(attributes.getPaddingLeft(), attributes.getPaddingTop(), attributes.getPaddingRight(), bottom);
